...
:::info
The nodes that support actions are [task nodes](../../flowx-elements/node/nodes-types/task-node/), [user task nodes](../../flowx-elements/node/nodes-types/user-task-node/), and [message send nodes](../../flowx-elements/node/nodes-types/message-send-received-task-node.md).
:::
