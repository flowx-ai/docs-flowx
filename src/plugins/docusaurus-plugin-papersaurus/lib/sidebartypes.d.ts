 ...
 *
 * This file is copied from docusaurus-plugin-content-docs, file types.ts,
 * but added 6 optional fields to SidebarItemDoc:
 *
 *  - articleHtml?: string;
 *  - stylePath?: string;
 *  - scriptPath?: string;
...
//# sourceMappingURL=sidebartypes.d.ts.map