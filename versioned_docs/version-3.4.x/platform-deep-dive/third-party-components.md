...
| ------------------------- | ---------------------------- | ---------------------------- |
| 2.3.0 → 3.4.0             | Keycloak                     | 18.2.0                       |
| 2.3.0 → 3.4.0             | Kafka / Zookeeper            | 3.2.3 / 3.6.6                |
| 2.3.0 → 3.4.0             | Jaeger                       | 1.34.1                       |
| 2.3.0 → 3.4.0             | AKHQ                         | 0.17.0                       |
| 2.3.0 → 3.4.0             | PostgreSQL                   | 14.3.0                       |
| 2.3.0 → 3.4.0             | MongoDB                      | 5.0.8                        |
| 2.3.0 → 3.4.0             | Redis                        | 6.2.6                        |
| 2.3.0 → 3.4.0             | NGINX Ingress Controller     | 1.2.0                        |
| 2.3.0 → 3.4.0             | Elasticsearch                | 7.17                         |
| 2.3.0 → 3.4.0             | Fluentd                      | 3.3.0                        |
| 2.3.0 → 3.4.0             | Kibana                       | 7.17                         |
| 2.3.0 → 3.4.0             | S3 (Min.IO) / minio-operator | 2022-05-26T05-48-41Z / 4.5.4 |
...
| FLOWX.AI Platform version | Component name | Supported/tested versions |
| ------------------------- | -------------- | ------------------------- |
| 2.3.0 → 3.4.0             | OracleDB       | 12C / 18-XE               |
