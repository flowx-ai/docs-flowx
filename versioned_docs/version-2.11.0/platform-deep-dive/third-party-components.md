...
| ------------------------- | ------------------------ | ------------------------- |
| 2.3.0 -> 2.11             | Keycloak                 | 9.0.2                     |
| 2.3.0 -> 2.11             | Kafka / Zookeeper        | 2.8.0 (3.5.9)             |
| 2.3.0 -> 2.11             | Jaeger                   | 1.34.1                    |
| 2.3.0 -> 2.11             | AKHQ                     | 0.17.0                    |
| 2.3.0 -> 2.11             | PostgreSQL               | 11.10.0                   |
| 2.3.0 -> 2.11             | MongoDB                  | 4.2.6                     |
| 2.3.0 -> 2.11             | Redis                    | 6.0.1                     |
| 2.3.0 -> 2.11             | NGINX Ingress Controller | 1.2.0                     |
| 2.3.0 -> 2.11             | Elasticsearch            | 7.9.3                     |
| 2.3.0 -> 2.11             | Fluentd                  | 3.3.0                     |
| 2.3.0 -> 2.11             | Kibana                   | 7.9.3                     |
| 2.3.0 -> 2.11             | S3 (Min.IO)              | RELEASE.2021-02-14        |
| 2.3.0 -> 2.11             | RabbitMQ                 | 3.7.17                    |

### Third-party components supported/tested versions

| FLOWX.AI Platform version | Component name | Supported/tested versions |
| ------------------------- | -------------- | ------------------------- |
| 2.3.0 -> 2.11             | OracleDB       | 12C / 18-XE               |
