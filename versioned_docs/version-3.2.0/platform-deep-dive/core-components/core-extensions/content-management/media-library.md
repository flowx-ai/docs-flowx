...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/media_library_add_new.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/media_library_preview.png)

### Searching assets

You can search an asset by using its key (full or substring).

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/search_asset.png)

### Replacing assets

You can replace an item on a specific key (this will not break references to process definitions).

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/replace_asset.gif)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/media_library_options.png)
