...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/proc_instance_progress.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/process_status.png)

## Understanding the Process Status Data

The process status data includes the following:

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/process_status_data.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/process_variables.png)

* **Tokens** - a token represents the state within the process instance and describe the current position in the process flow

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/process_tokens.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/process_exceptions.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/process_status_audit.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/process_export_smth.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/color_coding.gif)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/process_instance_diagram.png)
