...
![Start milestone node](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/milestone_node_start.png#center)
![End milestone node](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/milestone_node_end.png#center)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/milestone_node_modal_config.gif)
...
![Modal template](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/milestone_node_modal_config1.gif)
...
![Modal screen](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/modal_screen.png)

### Page

A basic full page content can be displayed using this kind of template on a milestone start.

![Page template](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/milestone_page.png)
...
![Example of a Stepper configuration with two steps](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/stepper_config_two_steps.png)
...
A container UI element allows us to display multiple user task on the same Page/Modal/Step with a different layout, other than the basic one. You can use **Layout** tab to play with multiple alignments.

![Container template](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/milestone_container.png)
