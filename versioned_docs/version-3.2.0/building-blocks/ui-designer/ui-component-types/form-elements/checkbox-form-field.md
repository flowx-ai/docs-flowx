...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/checkbox_form_field.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/checkbox_properties.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/checkbox_datasource.png)

#### Validators 

The following validators can be added to a checkbox: `required` and `custom` (more details [here](../../validators.md)).

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/checkbox_validators.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.2/checkbox_styling.png)