...
![Start milestone node](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.14/milestone_node_start.png#center)
![End milestone node](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.14/milestone_node_end.png#center)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.14/milestone_node_modal_config.gif)
...
![Modal template](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.14/milestone_node_modal_config1.gif)
...
![Modal screen](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.14/modal_screen.png)

### Page

A basic full page content can be displayed using this kind of template on a milestone start.

![Page template](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.14/milestone_page.png)
...
![Example of a Stepper configuration with two steps](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.14/stepper_config_two_steps.png)
...
![Container template](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.14/milestone_container.png)
