...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.13/timer_process_settings.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.13/timer_response_timeout.png)

* [**Actions**](../../building-blocks/actions.md) - **Timer expression** - it can be used if a delay is required on that action

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.13/timer_action_edit.png)