...
:::caution
Elastic search indexing must be switched on the FLOWX Engine configuration. You can find more details in the [**Search data service setup guide**](../../../platform-setup-guides/scheduler-setup-guide.md).
:::
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.13/topics_headers_body.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.13/search_data_no_result.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/2.13/search_data_response.png)
