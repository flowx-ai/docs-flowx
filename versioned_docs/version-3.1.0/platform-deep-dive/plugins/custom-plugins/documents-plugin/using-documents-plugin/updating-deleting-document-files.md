...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/doc_update_params.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/doc_update_topic.png)

4. Fill in the body message request:

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/doc_update_body.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/doc_update_ceva.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/doc_delete_general.png)

3. Add the [**Kafka topic**](../../../plugins-setup-guide/documents-plugin-setup/documents-plugin-setup.md#kafka-configuration) where to send the request:

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/doc_delete_topic.png)

4. Fill in the body message request:

![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/delete_doc_body.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/delete_doc_reply.png)
