...
* use Process Designer to add a [**Send Message Task**](../../../../../building-blocks/node/message-send-received-task-node.md#message-send-task) and a [**Receive Message Task**](../../../../../building-blocks/node/message-send-received-task-node.md#message-receive-task)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/notification_archi_send.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/send_a_notification_proc.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/send_a_notif_from_business_flow.gif)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/notif_params_send.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/generate_notif_receive.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/notif_send_resp.png)
