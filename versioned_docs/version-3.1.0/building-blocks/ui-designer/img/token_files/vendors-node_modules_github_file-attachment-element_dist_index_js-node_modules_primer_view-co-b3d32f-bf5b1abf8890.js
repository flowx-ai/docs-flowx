...
`;let b=a.querySelector("[data-crop-box]");if(!(b instanceof HTMLElement))return;let c=a.querySelector("img");c instanceof HTMLImageElement&&(i.set(this,{box:b,image:c}),c.addEventListener("load",()=>{this.loaded=!0,o(this)}),this.addEventListener("mouseleave",p),this.addEventListener("touchend",p),this.addEventListener("mouseup",p),b.addEventListener("mousedown",m),b.addEventListener("touchstart",m,{passive:!0}),this.addEventListener("keydown",j),this.addEventListener("keydown",k),this.src&&(c.src=this.src))}static get observedAttributes(){return["src"]}get src(){return this.getAttribute("src")}set src(a){a?this.setAttribute("src",a):this.removeAttribute("src")}get loaded(){return this.hasAttribute("loaded")}set loaded(a){a?this.setAttribute("loaded",""):this.removeAttribute("loaded")}attributeChangedCallback(a,b,c){let{image:d}=i.get(this)||{};"src"===a&&(this.loaded=!1,d&&(d.src=c))}}window.customElements.get("image-crop")||(window.ImageCropElement=ImageCropElement,window.customElements.define("image-crop",ImageCropElement)),c(11095);var r,s,t,u,v,w,x,y=c(48030),z=function(a,b,c,d,e){if("m"===d)throw TypeError("Private method is not writable");if("a"===d&&!e)throw TypeError("Private accessor was defined without a setter");if("function"==typeof b?a!==b||!e:!b.has(a))throw TypeError("Cannot write private member to an object whose class did not declare it");return"a"===d?e.call(a,c):e?e.value=c:b.set(a,c),c},A=function(a,b,c,d){if("a"===c&&!d)throw TypeError("Private accessor was defined without a getter");if("function"==typeof b?a!==b||!d:!b.has(a))throw TypeError("Cannot read private member from an object whose class did not declare it");return"m"===c?d:"a"===c?d.call(a):d?d.value:b.get(a)};let B="tooltip-open",C=["tooltip-n","tooltip-s","tooltip-e","tooltip-w","tooltip-ne","tooltip-se","tooltip-nw","tooltip-sw"];class ToolTipElement extends HTMLElement{constructor(){super(...arguments),r.add(this),s.set(this,void 0),t.set(this,"center"),u.set(this,"outside-bottom"),v.set(this,!1)}styles(){return`
      :host {
        position: absolute;
        z-index: 1000000;
        padding: .5em .75em;
