...
![FLOWX Designer](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_overview.gif#center)
...
![Process Definitions](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_process_definitions.gif)
...
![Active process](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_active_process.png)
...
![Content Management](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_cms.gif)
...
![Task Management](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_task_manager.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_notification_templates.png)
...
![Document templates plugin](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_documents.png)
...
![Generic Parameters](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_generic_params.png)
...
![Access Management](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_access_mng.png)
...
![](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_integrations.png)

## Checking platform status

You can quickly check the health status of all the FLOWX services and all of your custom connectors.

![Platform Status](https://s3.eu-west-1.amazonaws.com/docx.flowx.ai/3.1/designer_platform_status.png)
