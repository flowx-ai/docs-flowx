...
After updating to **3.5.0** FLOWX.AI release, it is not possible to import old process definitions into the new platform release (available for exports from releases **<= 3.5.0**).
:::
...
|              🧩                | 3.5.0 | 3.4.2  | 3.4.1  | 3.4.0  | 3.3.0   | 3.2.0  | 3.1.0  | 3.0.0  | 2.14.0   | 2.13.0  | 2.12.0  | 2.11.0  | 2.10.0  | 2.9.0   | 2.8.1   | 2.8.0   | 2.7.0   | 2.6.0   | 2.5.0   | 2.4.0   | 2.3.0   |
| :----------------------------: | ----- | ------ | ------ | ------ | ------- | ------ | ------ | ------ | -------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- |
...
|      **reporting-plugin**      |       | 0.0.40 | 0.0.40 | 0.0.40 | 0.0.40  | 0.0.40 | 0.0.40 | 0.0.39 | 0.0.39   | n/a     | n/a     | n/a     | n/a     | n/a     | n/a     | n/a     | n/a     | n/a     | n/a     | n/a     | n/a     |
...
### Recommended Versions for FLOWX.AI 3.5.0 ☑️

| FLOWX.AI Platform Version | Component name    | Recommended version (tested versions) |
| ------------------------- | ----------------- | ------------------------------------- |
| 3.5.0                     | Keycloak          | 18.0.x                                |
| 3.5.0                     | Kafka             | 3.2.3                                 |
| 3.5.0                     | PostgreSQL        | 14.3.0                                |
| 3.5.0                     | MongoDB           | 5.0.8                                 |
| 3.5.0                     | Redis             | 6.2.6                                 |
| 3.5.0                     | Elasticsearch     | 7.17                                  |
| 3.5.0                     | OracleDB          | 19.8.0.0.0                            |
| 3.5.0                     | Angular (Web SDK) | 15.0.0                                |
