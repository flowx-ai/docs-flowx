...
Check the deployments guildelines for more information about the impact on the configs:
...
![](../../docs/platform-deep-dive/img/events_gateway_archi.png)
...
* Added support for customizing icons in UI elements. You can now upload and manage SVG files for icons through the [Media Library](../../docs/platform-deep-dive/core-components/core-extensions/content-management/media-library)
...
Now you have the ability to send bulk update requests on Kafka. You can perform operations and send now multiple operations at once.
...
![](../../docs/building-blocks/img/swimlanes_docs.gif)

### Other

* Removed the autoarrange function from **Process Designer**
