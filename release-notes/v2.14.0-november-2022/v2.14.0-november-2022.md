...
* fixed a bug where when UI Elements were not correctly displayed after pasting them
...
* improvements
* now audit-logs are customizable (for cases when elasticSearch is shared with other systems or envs)
